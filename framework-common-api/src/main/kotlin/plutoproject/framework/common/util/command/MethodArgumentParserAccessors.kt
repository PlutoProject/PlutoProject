...
fun <C, T> CommandManager<C>.getKotlinMethodArgumentParser(): Class<ArgumentParser<C, T>> {
...
@Suppress("UNCHECKED_CAST", "UnusedReceiverParameter")
fun <C, T> CommandManager<C>.getMethodArgumentParser(): Class<ArgumentParser<C, T>> {
